...
\begin{tikzpicture}[thick,font=\sffamily,scale=1.5]
	...
	\draw[loosely dotted] (0,2) node[left]{$P_m$} -| node[pos=0.25,below=3mm] {} (1.18,0) node[below]{$q_m$}; %Qm dotted lines
  \draw[loosely dotted] (0,2) node[left]{} -| node[pos=0.25,below=3mm] {} (0.59,0) node[below]{$\frac{q_m}{2}$}; %Qm/2 dotted lines
	...
	\draw[loosely dotted] (5,2) node[above left]{$P_m$} -| node[pos=0.25,below=3mm] {} (6.18,0) node[below]{$q_m$}; %Qm dotted lines
	\draw[loosely dotted] (5,1.75) node[left]{$P_m-1$} -| node[pos=0.25,below=3mm] {} (6.5,0) node[below]{$q_1$}; %Pm-1 dotted lines
