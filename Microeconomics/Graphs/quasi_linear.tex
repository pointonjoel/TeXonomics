...
\begin{tikzpicture}[thick,font=\sffamily,scale=1.5]
 \draw (0,3.5) node[left]{$y$} -- (0,0) node[below left] {$0$} 
...
%dotted lines
 \draw[loosely dotted] (0.5,1) node[left]{} -| node[pos=0.25,below=3mm] {}
  (0.5,0) node[below]{$x_1$}; %x1 line  
 \draw[loosely dotted] (0.85,1) node[left]{} -| node[pos=0.25,below=3mm] {}
  (0.88,0) node[below]{$x_2$}; %x2 line 
 \draw[loosely dotted] (0,1) node[left]{$y_1$=$y_2$=$y_3$} -| node[pos=0.25,below=3mm] {}
  (1.3,0) node[below]{$x_3$}; %x3 and horizontal lines
