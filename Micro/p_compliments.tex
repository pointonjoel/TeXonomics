...
\begin{tikzpicture}[thick,font=\sffamily,scale=1.5]
	...
	\draw plot[domain=0:3.65,smooth] (\x,2.95-0.81*\x); %BC1
	 \draw (1.63,3.3) node[left]{} -- (1.63,1.63) node[below left] {} 
	  -- (3.3,1.63) node[below right]{IC1}; %IC1
	 \draw[loosely dotted] (0,1.63) node[left]{$y_1$} -| node[pos=0.25,below=3mm] {}
	  (1.63,0) node[below]{$x_1$}; %dotted lines
...
%y=x dotted line
	...
	%\draw (0,0) node[left]{} -- (3,3) node[below left] {};
\end{tikzpicture}
\end{document}